...
int main() {
    ...
    std::vector<std::string> keywords;
        cin.get(input, 100);
        if (check_text(input, keywords={"buletin", "identitate", "ci", "c.i.", "pasaport"})==1) {
            generalEVP_info();
            ...
            continuous(opt);
        } else if (check_text(input, keywords={"tir", "camion", "autorizatie tir", "acces oras"})==1) {
            ...
            continuous(opt);
        }else if (check_text(input, keywords={"nastere", "certificat"})==1) {
            ...
            continuous(opt);
        } else if (check_text(input, keywords={"decizii", "decizie", "hotarare"})==1) {
